    ...
    const displayGenre = () =>
        currGenre.map((movieId, ind) => {
            ...
            for (let obj of genreList) {
                if (obj.id === movieId) {
                    return ind === 2 ? <span>{obj.name}</span> : <span>{obj.name}, </span>;
                }
            }
            return null;
        });
                ...
                <div className="container .movie-details">
                    <div className="row ">
                        <div className="col-md-6 left-box col-md-push-6">
                            ...
                            <div>
                                <b>Rating: </b>{searchedMovie.vote_average}/10{" "}
                                <i className="fa-solid fa-star"></i>
                            </div>
                            <div>
                                <b>Release Date: </b>{searchedMovie.release_date}
                            </div>
                            <div>
                                <b>Genres: </b>{currGenre ? displayGenre() : null}
                            </div>
                            <div>
                                <button
